...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarPaisPorNombreDelAtleta();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar un atleta por su nombre");
	...
	private void ejecutarPaisPorNombreDelAtleta()
	{	
		String nombreAtleta = input("Ingrese el nombre del atleta");
		String pais = calculadora.buscarPaisDeUnAtletaPorSuNombre(nombreAtleta);
		if (pais == null)
			System.out.println("Ups! no hemos encontrado este atleta");
		else
			System.out.println("El atleta buscado es del pais " + pais);
	}
